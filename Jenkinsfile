...
pipeline{
  ...
  parameters {
    ...
    string(name: 'inputDefectOrJiraNo', defaultValue: "None", description: 'Defect no ')
    string(name: 'inputRequesterName', defaultValue: "Mosaic-aadmin", description: 'Enter the requester name')
  }
stages{
    stage('Setup'){
       steps{
